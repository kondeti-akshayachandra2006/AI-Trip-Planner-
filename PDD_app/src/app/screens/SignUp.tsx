    ...
    <div className="min-h-screen w-full bg-background p-6 flex flex-col">
      <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Start your journey with TripAI</p>
        </div>
        ...
        <Button variant="gradient" size="lg" className="w-full mb-4" onClick={handleSignUp} disabled={isSubmitting}>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button className="py-3 px-4 border border-border rounded-2xl hover:bg-muted transition-all flex items-center justify-center gap-2">
